...
const POPUP_SELECT =
  "id, title, image, link_href, start_date, end_date, sort_order, active";
...
/** 관리자 목록 — 전체, 정렬 순서 오름차순 */
export async function listPopups(): Promise<PopupRecord[]> {
 ...
 * 조회 실패/미설정 시 빈 배열.
 */
export async function getVisiblePopups(): Promise<PopupRecord[]> {
  try {
