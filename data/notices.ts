...
export const NOTICE_ITEMS: NoticeItem[] = [
  {
    ...
    category: "info",
    categoryLabel: "안내",
    title: "메타폴리스 주차 이용안내(지하주차장 입구 위치 변경)",
    date: "2026-07-01",
    body: [
      "메타폴리스 지하주차장 입구 위치가 아래와 같이 변경됩니다.",
  ...
  },
  {
    ...
    category: "info",
    categoryLabel: "안내",
    title: "메타폴리스 영업시간을 아래 내용과 같이 변경합니다",
    date: "2026-07-01",
    body: [
      "고객님의 편의를 위해 메타폴리스 영업시간을 아래와 같이 변경합니다.",
      "• 변경 전: 10:30 ~ 22:00",
