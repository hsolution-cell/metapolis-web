...
const EN_FLOOR_META: Record<BranchBlock, Omit<FloorGuideFloor, "stores">[]> = {
  a: [
    { id: "4f", label: "4F", summary: "CGV · Hair / Nail Salon · Nursery", mapImage: "/img/sub/floors/maps/a4_en.png", mapCaption: "A BLOCK · FLOOR DIRECTORY" },
    { id: "3f", label: "3F", summary: "CGV · Outback · Arcade · Restaurants", mapImage: "/img/sub/floors/maps/a3_en.png", mapCaption: "A BLOCK · FLOOR DIRECTORY" },
    { id: "2f", label: "2F", summary: "Men's / Women's Fashion · Info Desk", mapImage: "/img/sub/floors/maps/a2_en.png", mapCaption: "A BLOCK · FLOOR DIRECTORY" },
    { id: "1f", label: "1F", summary: "Sports · Outdoor · Cafes", mapImage: "/img/sub/floors/maps/a1_en.png", mapCaption: "A BLOCK · FLOOR DIRECTORY" },
    { id: "b2", label: "B2", summary: "SPA · F&B · Tech · Alterations", mapImage: "/img/sub/floors/maps/ab2_en.png", mapCaption: "A BLOCK · FLOOR DIRECTORY" },
  ],
  b: [
    { id: "4f", label: "4F", summary: "Aladdin · Culture · F&B", mapImage: "/img/sub/floors/maps/b4_en.png", mapCaption: "B BLOCK · FLOOR DIRECTORY" },
