...
import ParkingIcon from "@/components/sub/parking/ParkingIcons";
        ...
        <div className="parking_main_inner content_inner innerTop innerBot">
          ...
          >
            ...
            <p className="parking_notice_item">
              ...
              <span>
                <b>매장 결제 시 차량번호를 등록</b>하시면 <b>무료 주차 시간</b>
                이 적용됩니다
              </span>
            </p>
            <p className="parking_notice_item">
          ...
          >
            <div className="parking_map_sticky">
              ...
              <div className="parking_map_visual">
                <Image
                  src="/img/sub/parking/map.png"
                  alt="메타폴리스 A블록·B블록 주차장 입구 안내 지도"
                  width={620}
                  height={700}
            ...
            <div className="parking_info_panel">
              ...
              >
                ...
                <ol className="parking_process_list">
                  <li className="parking_process_item">
                    <div className="parking_process_card">
                      <span className="parking_process_icon parking_process_icon--entry">
                        <ParkingIcon type="entry" />
                      </span>
                      <p className="parking_process_label">
                        입차 차량
                        <br />
                        번호 인식
                      </p>
                  ...
                  <li className="parking_process_item">
                    <div className="parking_process_card">
                      <span className="parking_process_icon parking_process_icon--boxed">
                        <ParkingIcon type="confirm" />
                      </span>
                      <p className="parking_process_label">
                        구매 매장에서
                        <br />
              ...
              >
                ...
                <div className="parking_fee_card">
                  <span className="parking_fee_badge">
                    20시 ~ 익일 8시 · 50% 할인
                  </span>
                  <p className="parking_fee_headline">
                    최초 30분 무료 &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; 초과
                    10분당 500원
                  </p>
                  <dl className="parking_fee_details">
                    <div className="parking_fee_detail">
                      <dt>1일 최대 주차요금</dt>
                      <dd>20,000원</dd>
                    </div>
                    <div className="parking_fee_detail">
              ...
              >
                ...
                <div className="parking_benefits">
                  ...
                  <ul className="parking_special_list">
                    <li className="parking_special_card">
                      <p className="parking_special_title">클리닉 이용 시</p>
                      <span className="parking_special_icon">
                        <ParkingIcon type="clinic" />
                      </span>
                      <p className="parking_special_time">2시간 무료</p>
                    </li>
                    <li className="parking_special_card">
                      <p className="parking_special_title">CGV 이용 시</p>
                      <span className="parking_special_icon">
                        <ParkingIcon type="cgv" />
                      </span>
                      <p className="parking_special_time">3시간 무료</p>
                      <p className="parking_special_note">(셀프무인정산기)</p>
                    </li>
                  </ul>
                </div>
              </section>
